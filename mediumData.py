...
graph.add_trace(pg.Scatter(x=[firstsdStart, firstsdStart], y=[0,0.17], mode='lines', name='sd1Start'))
graph.add_trace(pg.Scatter(x=[firstsdEnd, firstsdEnd], y=[0,0.17], mode='lines', name='sd1End'))
graph.add_trace(pg.Scatter(x=[secondsdStart, secondsdStart], y=[0,0.17], mode='lines', name='sd2Start'))
graph.add_trace(pg.Scatter(x=[secondsdEnd, secondsdEnd], y=[0,0.17], mode='lines', name='sd2End'))
graph.add_trace(pg.Scatter(x=[thirdsdStart, thirdsdStart], y=[0,0.17], mode='lines', name='sd3Start'))
graph.add_trace(pg.Scatter(x=[thirdsdEnd, thirdsdEnd], y=[0,0.17], mode='lines', name='sd3End'))
#graph.show()
...
graph = pf.create_distplot([meanList], ['medium_data'], show_hist=False)
graph.add_trace(pg.Scatter(x=[mean, mean], y=[0,0.17], mode = 'lines', name = 'mean'))
graph.add_trace(pg.Scatter(x=[meanSample, meanSample], y=[0,0.17], mode='lines', name='Mean Sample'))
graph.add_trace(pg.Scatter(x=[firstsdEnd, firstsdEnd], y=[0,0.17], mode='lines', name='sd1End'))
graph.show()
